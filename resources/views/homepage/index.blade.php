        ...
        <section id="tamplate" class="max-w-7xl mx-auto py-8">
            ...
            <div id="templateContainer" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div class="template-item bg-white rounded-lg shadow-md overflow-hidden fade-enter fade-enter-active" data-category="pernikahan">
                <img src="{{ asset('assets/img/mockup-undangan/frame1.png') }}" alt="Ruwah Suci" class="w-full object-cover">
              ...
              <div class="template-item bg-white rounded-lg shadow-md overflow-hidden fade-enter fade-enter-active" data-category="kedukaan">
                <img src="{{ asset('assets/img/mockup-undangan/frame2.png') }}" alt="Modern Elegan" class="w-full object-cover">
                <div class="p-4 text-start">
              ...
              <!-- Card 3 (Pernikahan) -->
              <div class="template-item bg-white rounded-lg shadow-md overflow-hidden fade-enter fade-enter-active" data-category="pernikahan">
                <img src="{{ asset('assets/img/mockup-undangan/frame3.png') }}" alt="Nuansa Nostalgia" class="w-full object-cover">
                <div class="p-4 text-start">
              ...
              <div class="template-item bg-white rounded-lg shadow-md overflow-hidden fade-enter fade-enter-active" data-category="khitanan">
                <img src="{{ asset('assets/img/mockup-undangan/frame3.png') }}" alt="Khitanan Modern" class="w-full object-cover">
                <div class="p-4 text-start">
              ...
              <!-- Card 5 (pernikahan) -->
              <div class="template-item bg-white rounded-lg shadow-md overflow-hidden fade-enter fade-enter-active" data-category="pernikahan">
                <img src="{{ asset('assets/img/mockup-undangan/frame2.png') }}" alt="Khitanan Modern" class="w-full object-cover">
                <div class="p-4 text-start">
              ...
              <!-- Card 6 (duka) -->
              <div class="template-item bg-white rounded-lg shadow-md overflow-hidden fade-enter fade-enter-active" data-category="kedukaan">
                <img src="{{ asset('assets/img/mockup-undangan/frame1.png') }}" alt="Khitanan Modern" class="w-full object-cover">
                <div class="p-4 text-start">
